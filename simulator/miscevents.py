...
#from happeningSignalProxy import StateChangeEvent, SignalEvent
...
origToggleAction = QAction
origRadioAction = QAction

def performInterceptions():
    ''' Intercept class factories, redirect to our own '''
    """
    Qt TODO:
